...
> **Adaptada do ECC:** `production-audit` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/production-audit/SKILL.md`

## Descrição

--- name: production-audit description: Local-evidence production readiness audit for shipped apps, pre-launch reviews, post-merge checks, and "what breaks in prod?" questions without sending repo data to an external audit service.
