...
> **Adaptada do ECC:** `continuous-learning` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/continuous-learning/SKILL.md`
...
**ECC Original:** `ECC/skills/continuous-learning/SKILL.md`
