...
> **Adaptada do ECC:** `automation-audit-ops` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/automation-audit-ops/SKILL.md`

## Descrição

--- name: automation-audit-ops description: Evidence-first automation inventory and overlap audit workflow for ECC. Use when the user wants to know which jobs, hooks, connectors, MCP servers, or wrappers are live, broken, redundant, or missing before fixing anything.
...
**ECC Original:** `ECC/skills/automation-audit-ops/SKILL.md`
