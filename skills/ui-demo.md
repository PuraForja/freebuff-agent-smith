...
> **Adaptada do ECC:** `ui-demo` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/ui-demo/SKILL.md`

## Descrição

--- name: ui-demo description: Record polished UI demo videos using Playwright. Use when the user asks to create a demo, walkthrough, screen recording, or tutorial video of a web application. Produces WebM videos with visible cursor, natural pacing, and professional feel.
