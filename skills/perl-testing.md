...
> **Adaptada do ECC:** `perl-testing` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/perl-testing/SKILL.md`

## Descrição

--- name: perl-testing description: Perl testing patterns using Test2::V0, Test::More, prove runner, mocking, coverage with Devel::Cover, and TDD methodology.
...
**ECC Original:** `ECC/skills/perl-testing/SKILL.md`
