...
> **Adaptada do ECC:** `scientific-db-uspto-database` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/scientific-db-uspto-database/SKILL.md`

## Descrição

--- name: uspto-database description: USPTO patent and trademark data workflow for official record lookup, PatentSearch queries, TSDR checks, assignment data, and reproducible IP research logs.
