...
> **Adaptada do ECC:** `frontend-patterns` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/frontend-patterns/SKILL.md`

## Descrição

--- name: frontend-patterns description: Frontend development patterns for React, Next.js, state management, performance optimization, and UI best practices.
...
**ECC Original:** `ECC/skills/frontend-patterns/SKILL.md`
