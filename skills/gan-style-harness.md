...
> **Adaptada do ECC:** `gan-style-harness` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/gan-style-harness/SKILL.md`

## Descrição

--- name: gan-style-harness description: "GAN-inspired Generator-Evaluator agent harness for building high-quality applications autonomously. Based on Anthropic's March 2026 harness design paper."
