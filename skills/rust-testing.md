...
> **Adaptada do ECC:** `rust-testing` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/rust-testing/SKILL.md`

## Descrição

--- name: rust-testing description: Rust testing patterns including unit tests, integration tests, async testing, property-based testing, mocking, and coverage. Follows TDD methodology.
