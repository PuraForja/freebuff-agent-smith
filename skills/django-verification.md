...
> **Adaptada do ECC:** `django-verification` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/django-verification/SKILL.md`

## Descrição

--- name: django-verification description: "Verification loop for Django projects: migrations, linting, tests with coverage, security scans, and deployment readiness checks before release or PR."
...
**ECC Original:** `ECC/skills/django-verification/SKILL.md`
