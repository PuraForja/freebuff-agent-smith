...
> **Adaptada do ECC:** `android-clean-architecture` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/android-clean-architecture/SKILL.md`

## Descrição

--- name: android-clean-architecture description: Clean Architecture patterns for Android and Kotlin Multiplatform projects — module structure, dependency rules, UseCases, Repositories, and data layer patterns.
...
**ECC Original:** `ECC/skills/android-clean-architecture/SKILL.md`
