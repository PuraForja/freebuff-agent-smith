...
> **Adaptada do ECC:** `mle-workflow` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/mle-workflow/SKILL.md`

## Descrição

--- name: mle-workflow description: Production machine-learning engineering workflow for data contracts, reproducible training, model evaluation, deployment, monitoring, and rollback. Use when building, reviewing, or hardening ML systems beyond one-off notebooks.
