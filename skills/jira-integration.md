...
> **Adaptada do ECC:** `jira-integration` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/jira-integration/SKILL.md`

## Descrição

--- name: jira-integration description: Use this skill when retrieving Jira tickets, analyzing requirements, updating ticket status, adding comments, or transitioning issues. Provides Jira API patterns via MCP or direct REST calls.
