...
> **Adaptada do ECC:** `data-scraper-agent` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/data-scraper-agent/SKILL.md`
...
**ECC Original:** `ECC/skills/data-scraper-agent/SKILL.md`
