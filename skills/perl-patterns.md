...
> **Adaptada do ECC:** `perl-patterns` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/perl-patterns/SKILL.md`

## Descrição

--- name: perl-patterns description: Modern Perl 5.36+ idioms, best practices, and conventions for building robust, maintainable Perl applications.
...
**ECC Original:** `ECC/skills/perl-patterns/SKILL.md`
