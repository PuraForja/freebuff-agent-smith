...
> **Adaptada do ECC:** `fal-ai-media` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/fal-ai-media/SKILL.md`

## Descrição

--- name: fal-ai-media description: Unified media generation via fal.ai MCP — image, video, and audio. Covers text-to-image (Nano Banana), text/image-to-video (Seedance, Kling, Veo 3), text-to-speech (CSM-1B), and video-to-audio (ThinkSound). Use when the user wants to generate images, videos, or audio with AI.
...
**ECC Original:** `ECC/skills/fal-ai-media/SKILL.md`
