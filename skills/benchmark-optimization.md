# 🧠 Skill: benchmark-optimization

> **Adaptada do ECC:** `benchmark-optimization-loop` — via `sync-ecc.sh`
> **Fonte original:** `ECC/skills/benchmark-optimization-loop/SKILL.md`
...
- **ECC Original:** `ECC/skills/benchmark-optimization-loop/SKILL.md`
