...
> **Adaptada do ECC:** `database-migrations` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/database-migrations/SKILL.md`

## Descrição

--- name: database-migrations description: Database migration best practices for schema changes, data migrations, rollbacks, and zero-downtime deployments across PostgreSQL, MySQL, and common ORMs (Prisma, Drizzle, Kysely, Django, TypeORM, golang-migrate).
...
**ECC Original:** `ECC/skills/database-migrations/SKILL.md`
