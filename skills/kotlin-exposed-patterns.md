...
> **Adaptada do ECC:** `kotlin-exposed-patterns` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/kotlin-exposed-patterns/SKILL.md`

## Descrição

--- name: kotlin-exposed-patterns description: JetBrains Exposed ORM patterns including DSL queries, DAO pattern, transactions, HikariCP connection pooling, Flyway migrations, and repository pattern.
...
**ECC Original:** `ECC/skills/kotlin-exposed-patterns/SKILL.md`
