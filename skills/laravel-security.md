...
> **Adaptada do ECC:** `laravel-security` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/laravel-security/SKILL.md`

## Descrição

--- name: laravel-security description: Laravel security best practices — authentication, authorization, Eloquent safety, CSRF, XSS prevention, API security, and secure deployment configurations.
...
**ECC Original:** `ECC/skills/laravel-security/SKILL.md`
