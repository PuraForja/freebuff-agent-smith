...
> **Adaptada do ECC:** `ai-regression-testing` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/ai-regression-testing/SKILL.md`

## Descrição

--- name: ai-regression-testing description: Regression testing strategies for AI-assisted development. Sandbox-mode API testing without database dependencies, automated bug-check workflows, and patterns to catch AI blind spots where the same model writes and reviews code.
...
**ECC Original:** `ECC/skills/ai-regression-testing/SKILL.md`
