...
> **Adaptada do ECC:** `laravel-tdd` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/laravel-tdd/SKILL.md`

## Descrição

--- name: laravel-tdd description: Laravel testing strategies with PHPUnit, Pest, model factories, HTTP tests, Sanctum authentication testing, mocking, and coverage.
...
**ECC Original:** `ECC/skills/laravel-tdd/SKILL.md`
