...
> **Adaptada do ECC:** `springboot-security` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/springboot-security/SKILL.md`
...
**ECC Original:** `ECC/skills/springboot-security/SKILL.md`
