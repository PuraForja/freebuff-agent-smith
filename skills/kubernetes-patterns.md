...
> **Adaptada do ECC:** `kubernetes-patterns` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/kubernetes-patterns/SKILL.md`

## Descrição

--- name: kubernetes-patterns description: Kubernetes workload patterns, resource management, RBAC, probes, autoscaling, ConfigMap/Secret handling, and kubectl debugging for production-grade deployments.
