...
> **Adaptada do ECC:** `prompt-optimizer` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/prompt-optimizer/SKILL.md`

## Descrição

--- name: prompt-optimizer description: >-
...
**ECC Original:** `ECC/skills/prompt-optimizer/SKILL.md`
