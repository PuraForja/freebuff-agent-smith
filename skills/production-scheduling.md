...
> **Adaptada do ECC:** `production-scheduling` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/production-scheduling/SKILL.md`

## Descrição

--- name: production-scheduling description: >
...
**ECC Original:** `ECC/skills/production-scheduling/SKILL.md`
