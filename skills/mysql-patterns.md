...
> **Adaptada do ECC:** `mysql-patterns` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/mysql-patterns/SKILL.md`

## Descrição

--- name: mysql-patterns description: MySQL and MariaDB schema, query, indexing, transaction, replication, and connection-pool patterns for production backends.
...
**ECC Original:** `ECC/skills/mysql-patterns/SKILL.md`
