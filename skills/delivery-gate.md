...
> **Adaptada do ECC:** `delivery-gate` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/delivery-gate/SKILL.md`

## Descrição

--- name: delivery-gate description: Stop hook that blocks Claude from finishing until quality checks pass. Detects rationalization patterns (surface text heuristics), stale learning logs (filesystem mtime), and low disk space. Complements self-audit by mechanically enforcing learning capture habits.
...
**ECC Original:** `ECC/skills/delivery-gate/SKILL.md`
