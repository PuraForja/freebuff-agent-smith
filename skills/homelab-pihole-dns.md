...
> **Adaptada do ECC:** `homelab-pihole-dns` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/homelab-pihole-dns/SKILL.md`

## Descrição

--- name: homelab-pihole-dns description: Pi-hole installation, blocklist management, DNS-over-HTTPS setup, DHCP integration, local DNS records, and troubleshooting broken DNS resolution on a home network.
