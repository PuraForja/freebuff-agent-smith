...
> **Adaptada do ECC:** `santa-method` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/santa-method/SKILL.md`

## Descrição

--- name: santa-method description: "Multi-agent adversarial verification with convergence loop. Two independent review agents must both pass before output ships."
