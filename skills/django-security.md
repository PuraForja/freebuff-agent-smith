...
> **Adaptada do ECC:** `django-security` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/django-security/SKILL.md`

## Descrição

--- name: django-security description: Django security best practices, authentication, authorization, CSRF protection, SQL injection prevention, XSS prevention, and secure deployment configurations.
...
**ECC Original:** `ECC/skills/django-security/SKILL.md`
