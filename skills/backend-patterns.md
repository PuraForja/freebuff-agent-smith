...
> **Adaptada do ECC:** `backend-patterns` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/backend-patterns/SKILL.md`
...
**ECC Original:** `ECC/skills/backend-patterns/SKILL.md`
