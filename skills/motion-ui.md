...
> **Adaptada do ECC:** `motion-ui` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/motion-ui/SKILL.md`

## Descrição

--- name: motion-ui description: "Production-ready UI motion system for React/Next.js. Use when implementing animations, transitions, or motion patterns."
