...
> **Adaptada do ECC:** `rules-distill` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/rules-distill/SKILL.md`

## Descrição

--- name: rules-distill description: "Scan skills to extract cross-cutting principles and distill them into rules — append, revise, or create new rule files"
