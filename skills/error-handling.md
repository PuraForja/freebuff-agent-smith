...
> **Adaptada do ECC:** `error-handling` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/error-handling/SKILL.md`

## Descrição

--- name: error-handling description: Patterns for robust error handling across TypeScript, Python, and Go. Covers typed errors, error boundaries, retries, circuit breakers, and user-facing error messages.
