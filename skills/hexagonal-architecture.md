...
> **Adaptada do ECC:** `hexagonal-architecture` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/hexagonal-architecture/SKILL.md`

## Descrição

--- name: hexagonal-architecture description: Design, implement, and refactor Ports & Adapters systems with clear domain boundaries, dependency inversion, and testable use-case orchestration across TypeScript, Java, Kotlin, and Go services.
