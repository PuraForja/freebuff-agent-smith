...
> **Adaptada do ECC:** `fsharp-testing` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/fsharp-testing/SKILL.md`

## Descrição

--- name: fsharp-testing description: F# testing patterns with xUnit, FsUnit, Unquote, FsCheck property-based testing, integration tests, and test organization best practices.
