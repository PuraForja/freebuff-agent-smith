...
> **Adaptada do ECC:** `windows-desktop-e2e` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/windows-desktop-e2e/SKILL.md`

## Descrição

--- name: windows-desktop-e2e description: E2E testing for Windows native desktop apps (WPF, WinForms, Win32/MFC, Qt) using pywinauto and Windows UI Automation.
