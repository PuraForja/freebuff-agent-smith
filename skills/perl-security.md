...
> **Adaptada do ECC:** `perl-security` — via `ecc-install.sh`
> **Fonte original:** `ECC/skills/perl-security/SKILL.md`

## Descrição

--- name: perl-security description: Comprehensive Perl security covering taint mode, input validation, safe process execution, DBI parameterized queries, web security (XSS/SQLi/CSRF), and perlcritic security policies.
...
**ECC Original:** `ECC/skills/perl-security/SKILL.md`
