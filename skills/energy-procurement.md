...
> **Adaptada do ECC:** `energy-procurement` — via `sync-ecc.sh`
> **Fonte original:** `ECC/skills/energy-procurement/SKILL.md`
...
- **Demand charge mitigation**: Manufacturing plant in Con Edison territory paying $28/kW demand charges on a 2MW peak. Analyze interval data to identify the top 10 demand-setting intervals, evaluate

---

**ECC Original:** `ECC/skills/energy-procurement/SKILL.md`
