# 🎯 Agente: network-config-reviewer

**Adaptado do ECC:** `network-config-reviewer`
**Fonte:** `ECC/agents/network-config-reviewer.md`
...
## Como usar
> @"network-config-reviewer" [sua solicitação]
