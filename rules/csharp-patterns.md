# 📏 Regra: csharp — patterns

> **Adaptada do ECC:** \`rules/csharp/patterns.md\`
> **Fonte original:** \`ECC/rules/csharp/patterns.md\`

## Descrição

Regra ECC para csharp: patterns
...
**ECC Original:** \`ECC/rules/csharp/patterns.md\`
