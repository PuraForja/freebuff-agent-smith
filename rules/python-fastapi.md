# 📏 Regra: python — fastapi

> **Adaptada do ECC:** \`rules/python/fastapi.md\`
> **Fonte original:** \`ECC/rules/python/fastapi.md\`

## Descrição

Regra ECC para python: fastapi
...
**ECC Original:** \`ECC/rules/python/fastapi.md\`
