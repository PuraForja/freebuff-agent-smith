# 📏 Regra: react-native — coding-style

> **Adaptada do ECC:** \`rules/react-native/coding-style.md\`
> **Fonte original:** \`ECC/rules/react-native/coding-style.md\`

## Descrição

Regra ECC para react-native: coding-style
...
**ECC Original:** \`ECC/rules/react-native/coding-style.md\`
