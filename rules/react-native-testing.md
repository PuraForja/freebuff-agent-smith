# 📏 Regra: react-native — testing

> **Adaptada do ECC:** \`rules/react-native/testing.md\`
> **Fonte original:** \`ECC/rules/react-native/testing.md\`

## Descrição

Regra ECC para react-native: testing
...
**ECC Original:** \`ECC/rules/react-native/testing.md\`
