# 📏 Regra: react-native — accessibility

> **Adaptada do ECC:** \`rules/react-native/accessibility.md\`
> **Fonte original:** \`ECC/rules/react-native/accessibility.md\`

## Descrição

Regra ECC para react-native: accessibility
...
**ECC Original:** \`ECC/rules/react-native/accessibility.md\`
