# 📏 Regra: csharp — testing

> **Adaptada do ECC:** \`rules/csharp/testing.md\`
> **Fonte original:** \`ECC/rules/csharp/testing.md\`

## Descrição

Regra ECC para csharp: testing
...
**ECC Original:** \`ECC/rules/csharp/testing.md\`
