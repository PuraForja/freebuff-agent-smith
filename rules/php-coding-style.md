# 📏 Regra: php — coding-style

> **Adaptada do ECC:** \`rules/php/coding-style.md\`
> **Fonte original:** \`ECC/rules/php/coding-style.md\`

## Descrição

Regra ECC para php: coding-style
...
**ECC Original:** \`ECC/rules/php/coding-style.md\`
