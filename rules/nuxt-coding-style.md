# 📏 Regra: nuxt — coding-style

> **Adaptada do ECC:** \`rules/nuxt/coding-style.md\`
> **Fonte original:** \`ECC/rules/nuxt/coding-style.md\`

## Descrição

Regra ECC para nuxt: coding-style
...
**ECC Original:** \`ECC/rules/nuxt/coding-style.md\`
