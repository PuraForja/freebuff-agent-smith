# 📏 Regra: kotlin — testing

> **Adaptada do ECC:** \`rules/kotlin/testing.md\`
> **Fonte original:** \`ECC/rules/kotlin/testing.md\`

## Descrição

Regra ECC para kotlin: testing
...
**ECC Original:** \`ECC/rules/kotlin/testing.md\`
