# 📏 Regra: csharp — security

> **Adaptada do ECC:** \`rules/csharp/security.md\`
> **Fonte original:** \`ECC/rules/csharp/security.md\`

## Descrição

Regra ECC para csharp: security
...
**ECC Original:** \`ECC/rules/csharp/security.md\`
