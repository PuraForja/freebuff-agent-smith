# 📏 Regra: cpp — coding-style

> **Adaptada do ECC:** \`rules/cpp/coding-style.md\`
> **Fonte original:** \`ECC/rules/cpp/coding-style.md\`

## Descrição

Regra ECC para cpp: coding-style
...
**ECC Original:** \`ECC/rules/cpp/coding-style.md\`
