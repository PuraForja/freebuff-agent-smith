# 📏 Regra: fsharp — coding-style

> **Adaptada do ECC:** \`rules/fsharp/coding-style.md\`
> **Fonte original:** \`ECC/rules/fsharp/coding-style.md\`

## Descrição

Regra ECC para fsharp: coding-style
...
**ECC Original:** \`ECC/rules/fsharp/coding-style.md\`
