# 📏 Regra: react-native — production-readiness

> **Adaptada do ECC:** \`rules/react-native/production-readiness.md\`
> **Fonte original:** \`ECC/rules/react-native/production-readiness.md\`

## Descrição

Regra ECC para react-native: production-readiness
...
**ECC Original:** \`ECC/rules/react-native/production-readiness.md\`
