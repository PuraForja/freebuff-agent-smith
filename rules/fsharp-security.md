# 📏 Regra: fsharp — security

> **Adaptada do ECC:** \`rules/fsharp/security.md\`
> **Fonte original:** \`ECC/rules/fsharp/security.md\`

## Descrição

Regra ECC para fsharp: security
...
**ECC Original:** \`ECC/rules/fsharp/security.md\`
