# 📏 Regra: react-native — performance

> **Adaptada do ECC:** \`rules/react-native/performance.md\`
> **Fonte original:** \`ECC/rules/react-native/performance.md\`

## Descrição

Regra ECC para react-native: performance
...
**ECC Original:** \`ECC/rules/react-native/performance.md\`
