# 📏 Regra: kotlin — security

> **Adaptada do ECC:** \`rules/kotlin/security.md\`
> **Fonte original:** \`ECC/rules/kotlin/security.md\`

## Descrição

Regra ECC para kotlin: security
...
**ECC Original:** \`ECC/rules/kotlin/security.md\`
