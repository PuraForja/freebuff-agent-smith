# 📏 Regra: react-native — patterns

> **Adaptada do ECC:** \`rules/react-native/patterns.md\`
> **Fonte original:** \`ECC/rules/react-native/patterns.md\`

## Descrição

Regra ECC para react-native: patterns
...
**ECC Original:** \`ECC/rules/react-native/patterns.md\`
