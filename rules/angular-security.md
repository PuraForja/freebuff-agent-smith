# 📏 Regra: angular — security

> **Adaptada do ECC:** \`rules/angular/security.md\`
> **Fonte original:** \`ECC/rules/angular/security.md\`

## Descrição

Regra ECC para angular: security
...
**ECC Original:** \`ECC/rules/angular/security.md\`
