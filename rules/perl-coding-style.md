# 📏 Regra: perl — coding-style

> **Adaptada do ECC:** \`rules/perl/coding-style.md\`
> **Fonte original:** \`ECC/rules/perl/coding-style.md\`

## Descrição

Regra ECC para perl: coding-style
...
**ECC Original:** \`ECC/rules/perl/coding-style.md\`
