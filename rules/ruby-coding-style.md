# 📏 Regra: ruby — coding-style

> **Adaptada do ECC:** \`rules/ruby/coding-style.md\`
> **Fonte original:** \`ECC/rules/ruby/coding-style.md\`

## Descrição

Regra ECC para ruby: coding-style
...
**ECC Original:** \`ECC/rules/ruby/coding-style.md\`
