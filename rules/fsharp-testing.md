# 📏 Regra: fsharp — testing

> **Adaptada do ECC:** \`rules/fsharp/testing.md\`
> **Fonte original:** \`ECC/rules/fsharp/testing.md\`

## Descrição

Regra ECC para fsharp: testing
...
**ECC Original:** \`ECC/rules/fsharp/testing.md\`
