# 📏 Regra: vue — coding-style

> **Adaptada do ECC:** \`rules/vue/coding-style.md\`
> **Fonte original:** \`ECC/rules/vue/coding-style.md\`

## Descrição

Regra ECC para vue: coding-style
...
**ECC Original:** \`ECC/rules/vue/coding-style.md\`
