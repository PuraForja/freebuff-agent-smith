# 📏 Regra: csharp — coding-style

> **Adaptada do ECC:** \`rules/csharp/coding-style.md\`
> **Fonte original:** \`ECC/rules/csharp/coding-style.md\`

## Descrição

Regra ECC para csharp: coding-style
...
**ECC Original:** \`ECC/rules/csharp/coding-style.md\`
