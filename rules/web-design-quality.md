# 📏 Regra: web — design-quality

> **Adaptada do ECC:** \`rules/web/design-quality.md\`
> **Fonte original:** \`ECC/rules/web/design-quality.md\`
...
**ECC Original:** \`ECC/rules/web/design-quality.md\`
