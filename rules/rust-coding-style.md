# 📏 Regra: rust — coding-style

> **Adaptada do ECC:** \`rules/rust/coding-style.md\`
> **Fonte original:** \`ECC/rules/rust/coding-style.md\`
...
**ECC Original:** \`ECC/rules/rust/coding-style.md\`
