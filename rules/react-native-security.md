# 📏 Regra: react-native — security

> **Adaptada do ECC:** \`rules/react-native/security.md\`
> **Fonte original:** \`ECC/rules/react-native/security.md\`

## Descrição

Regra ECC para react-native: security
...
**ECC Original:** \`ECC/rules/react-native/security.md\`
