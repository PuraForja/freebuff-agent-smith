# 📏 Regra: java — coding-style

> **Adaptada do ECC:** \`rules/java/coding-style.md\`
> **Fonte original:** \`ECC/rules/java/coding-style.md\`
...
**ECC Original:** \`ECC/rules/java/coding-style.md\`
